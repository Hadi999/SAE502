...
<a href="../page3_forgotpassword/forgotpassword.html">Forgot Password</a>
</div>
</div>
</form>
<p class="text-center"><a href="../page1_signin/index.html">Sign In</a></p>  <!-- ################################################################################# -->
</div>
</div>
</div>
</div>
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (!empty($username) && !empty($mdp) && !empty($mail)) {
    ...
    if (!validerMotDePasse($mdp)) {
        ...
        echo "<script> setTimeout(function() {window.location.href = 'signin.php'}, 10)</script>";
    }
}
}
?>
